...
function SearchBar({ search, setSearch }) {
  return (
    <div className="bg-white dark:bg-blue-900 px-8 h-12 flex gap-5 items-center shadow-[0_2px_9px_rgba(0,0,0,0.06)] rounded-[5px] tablet:grow tablet:max-w-120 tablet:h-14">
